...
Current release: **v8.3.2** — download from [GitHub Releases](../../releases).
...
3. Toggle the **Profile Values** on the Unlocks page (Credits, Wheelspins, Skill Points, Freeze AI, …), or use **Instant Rewards** to set wheelspin counts directly.
4. SQL cheats (cars, upgrades, physics) are on the Database page — one click.
5. Change the season from the Unlocks page at any time.
...
- Writes wheelspin / super-wheelspin counts directly into the reward wallet (data write, no hooks)
...
### Season (Unlocks page)
- Switch Spring / Summer / Autumn / Winter instantly
